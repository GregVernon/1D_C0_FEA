...
#         domain = [ 0, 1 ]
#         degree = [2]*2
#         uspline_bext = bext.readBEXT( "data/two_element_quadratic_unit_bspline.json" )
...
#         domain = [ -2, 2 ]
#         degree = [3]*2
#         uspline_bext = bext.readBEXT( "data/two_element_cubic_quadriunit_bspline.json" )
#         test_sol_coeff = computeSolution( target_fun = target_fun, uspline_bext = uspline_bext )
#         abs_err, rel_err = computeFitError( target_fun, test_sol_coeff, uspline_bext )
#         # plotCompareFunToTestSolution( target_fun, test_sol_coeff, uspline_bext )
#         self.assertAlmostEqual( first = rel_err, second = 0, delta = 1e-1 )
...
#         domain = [ -1, 1 ]
#         degree = [5]*2
#         uspline_bext = bext.readBEXT( "data/two_element_pentic_biunit_c0_bspline.json" )
#         test_sol_coeff = computeSolution( target_fun = target_fun, uspline_bext = uspline_bext )
#         abs_err, rel_err = computeFitError( target_fun, test_sol_coeff, uspline_bext )
#         # plotCompareFunToTestSolution( target_fun, test_sol_coeff, uspline_bext )
...
class Test_assembleGramMatrix( unittest.TestCase ):
    def test_linear_two_element_quadratic_bspline( self ):
        ...
        gold_gram_matrix = numpy.array( [ [ 1.0/10.0, 7.0/120.0, 1.0/120.0, 0.0 ], 
                                          [ 7.0/120.0, 1.0/6.0, 1.0/10.0, 1.0/120.0],
                                          [ 1.0/120.0, 1.0/10.0, 1.0/6.0, 7.0/120.0 ],
                                          [ 0.0, 1.0/120.0, 7.0/120.0, 1.0/10.0] ] )
